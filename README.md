...
- Git Copilot Spaces - https://github.com/dimanikulin/skills-scale-institutional-knowledge-using-copilot-spaces/issues/1
...
| 7 | Cursor rules | [DOU](https://dou.ua/forums/topic/56845/?from=tg&utm_source=telegram&utm_medium=social) | | |
| 8 | Readme.md for agents | [agents.md](https://agents.md/) | TBD | TBD | TBD |
| 9 | Readme.md for skills | [skills.sh](https://skills.sh/) | TBD | TBD | TBD  |
